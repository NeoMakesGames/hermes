...
public class LogNonHermesModsTest {
	 ...
	 * non-hermes mods found.
	 */
	@Test
	public void testLogNonHermesMods() {
		List<Path> nonHermesMods = new ArrayList<Path>();
		nonHermesMods.add(Paths.get("mods/non_fabric_mod1.jar"));
		nonHermesMods.add(Paths.get("mods/non_fabric_mod2.jar"));
		nonHermesMods.add(Paths.get("mods/non_fabric_mod3.jar"));
